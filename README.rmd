...
Jedid Ahn, Derek Beaton, Roberto Lentini, Logan Lim, & Jeremy Tanuan, 2021JAN25
...
3. Type ```ONDRIStandardsApp::installPackages()``` to install any missing packages and/or dependencies.
...
4. When installation is complete, type ```ONDRIStandardsApp::runApp()``` to open the app.
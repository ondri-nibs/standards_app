# outputMissingErrorMessage.R
#
# Purpose: Create the server logic to output an error message to the screen
# when a folder and/or file(s) selected are missing and do not exist.
#
...
outputMissingErrorMessage <- function(combinedWarningText){
  # Output an error message.
  errorMsg <- paste(
    tags$div(img(class = "caution", src = "caution.jpg"),
             tags$span(id = "error-title", 
                       "ERROR: A folder and/or file(s) selected are missing."))
  )

# lvl1Server.R
#
# Purpose: Create the server logic for the level 1 tab for lvl 1 structure checks.
#
...
source("server/lvl1checks/checkLvl1Required.R")

source("server/lvl1checks/checkLvl1READMEColumnNames.R")
source("server/lvl1checks/checkLvl1DICTColumnNames.R")
source("server/lvl1checks/checkLvl1DATAColumnNames.R")
source("server/lvl1checks/checkLvl1MISSINGColumnNames.R")

source("server/lvl1checks/checkLvl1Directory.R")
source("server/lvl1checks/checkFileExt.R")
source("server/lvl1checks/checkLvl1README.R")
source("server/lvl1checks/getInvalidLvl1README.R")
source("server/lvl1checks/checkLvl1DICT.R")
source("server/lvl1checks/getInvalidLvl1DICT.R")
source("server/lvl1checks/checkLvl1DATA.R")
source("server/lvl1checks/getInvalidLvl1DATA.R")
source("server/lvl1checks/checkLvl1MISSING.R")
source("server/lvl1checks/getInvalidLvl1MISSING.R")

lvl1Server <- function(input, output, session){
  lvl1RequiredFileTypes <- c("README.csv", "METHODS.pdf")
  lvl <- 1

  # Disable checkboxes that are mandatory checks.
  disable("checkLvl1Required1")
  disable("checkLvl1Required2")
  disable("checkLvl1Required3")
  disable("checkLvl1Required4")
  disable("checkLvl1READMEColumnNames")
  disable("checkLvl1DICTColumnNames")
  disable("checkLvl1DATAColumnNames")
  disable("checkLvl1MISSINGColumnNames")
  disable("checkLvl1DirName1")
  disable("checkLvl1DirName2")
  
  observeEvent(
    # Run code only if "Check Directory" button is clicked.
    input$lvl1CheckDirButton, {
      ...
      XML_general_attr("DIR", "lvl", "1")
      
      # Clear output text section to make blank.
      output$lvl1OutputText <- renderText("")
      # Clear output ID section first to make blank.
      output$lvl1OutputID <- renderText("")
      # Clear dropdown list.
      ...
      # Print onto screen.
      output$lvl1OutputText <- renderPrint(flaggedMsgs)
    }
  )
  ...
  observeEvent(
    ...
    input$lvl1CheckMISSINGButton, {
      
      # Log input
      XML_add_child("checks", "<MISSING/>")
      XML_general_attr("MISSING", "lvl", "1")

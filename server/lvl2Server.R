...
source("server/lvl2checks/checkLvl2Required.R")

source("server/lvl2checks/checkLvl2READMEColumnNames.R")
source("server/lvl2checks/checkLvl2DICTColumnNames.R")
source("server/lvl2checks/checkLvl2DATAColumnNames.R")
source("server/lvl2checks/checkLvl2MISSINGColumnNames.R")

source("server/lvl2checks/checkLvl2Directory.R")
source("server/lvl2checks/checkLvl2DirNames.R")
source("server/lvl2checks/checkLvl2README.R")
source("server/lvl2checks/getInvalidLvl2README.R")
source("server/lvl2checks/checkLvl2DICT.R")
source("server/lvl2checks/getInvalidLvl2DICT.R")
source("server/lvl2checks/checkLvl2DATA.R")
source("server/lvl2checks/getInvalidLvl2DATA.R")
source("server/lvl2checks/checkLvl2MISSING.R")
source("server/lvl2checks/getInvalidLvl2MISSING.R")
